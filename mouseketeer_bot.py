"""Mouseketeer - A simple mouse clicker to keep your PC active by moving and right-clicking the mouse cursor periodically."""
...
def run_clicker(interval_seconds, total_duration_minutes):
    ...
    try:
        ...
        if clicker_running:
            messagebox.showinfo("Done", "Mouseketeer session complete.")
...
def minimize_to_tray():
    ...
    tray_icon = pystray.Icon("Mouseketeer", icon_image, "Mouseketeer", menu=pystray.Menu(
